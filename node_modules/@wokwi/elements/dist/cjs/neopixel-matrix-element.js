 ...
 * pixel to red.
 */
let NeopixelMatrixElement = class NeopixelMatrixElement extends lit_element_1.LitElement {
    constructor() {
        super(...arguments);
        /**
...
__decorate([
    lit_element_1.property({ attribute: 'colspacing' })
...
__decorate([
    lit_element_1.property({ attribute: 'rowspacing' })
], NeopixelMatrixElement.prototype, "rowSpacing", void 0);
NeopixelMatrixElement = __decorate([
    lit_element_1.customElement('wokwi-neopixel-matrix')
