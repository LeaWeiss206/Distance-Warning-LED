...
let ArduinoUnoElement = class ArduinoUnoElement extends lit_element_1.LitElement {
    constructor() {
        super(...arguments);
        this.led13 = false;
        this.ledRX = false;
    ...
    render() {
      ...
      >
        ...
        <g transform="translate(57.3, 16.21)">
          ...
          ${ledPower &&
            lit_element_1.svg `<circle cx="1.3" cy="0.55" r="1.3" fill="#80ff80" filter="url(#ledFilter)" />`}
        </g>
        ...
        <g transform="translate(26.87,11.69)">
          <use xlink:href="#led-body" />
          ${led13 &&
            lit_element_1.svg `<circle cx="1.3" cy="0.55" r="1.3" fill="#ff8080" filter="url(#ledFilter)" />`}
        </g>

        <g transform="translate(26.9, 16.2)">
          <use xlink:href="#led-body" />
          ${ledTX &&
            lit_element_1.svg `<circle cx="0.975" cy="0.55" r="1.3" fill="yellow" filter="url(#ledFilter)" />`}
        </g>
...
ArduinoUnoElement = __decorate([
    lit_element_1.customElement('wokwi-arduino-uno')
], ArduinoUnoElement);
